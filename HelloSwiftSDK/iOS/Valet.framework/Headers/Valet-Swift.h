...
typedef SWIFT_ENUM_NAMED(NSInteger, VALAccessibility, "Accessibility") {
...
typedef SWIFT_ENUM_NAMED(NSInteger, VALCloudAccessibility, "CloudAccessibility") {
/// Valet data can only be accessed while the device is unlocked. This attribute is recommended for data that only needs to be accessible while the application is in the foreground. Valet data with this attribute will migrate to a new device when using encrypted backups.
...
typedef SWIFT_ENUM_NAMED(NSInteger, VALMigrationResult, "MigrationResult") {
/// Migration succeeded.
...
typedef SWIFT_ENUM_NAMED(NSInteger, VALSecureEnclaveAccessControl, "SecureEnclaveAccessControl") {
...
/// version:
/// Available on iOS 8 or later, tvOS 8 or later, and macOS 10.11 or later.
...
/// version:
/// Available on iOS 9 or later, tvOS 9 or later, and macOS 10.12.1 or later.
...
/// version:
/// Available on iOS 9 or later, tvOS 9 or later, and macOS 10.11 or later.
